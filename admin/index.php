...
<head>
    ...
    <style>
        ...
        .badge-private { background: #555; font-size: .7rem; }
...
<div class="container-fluid px-3 py-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="mb-0 text-light">写真一覧</h5>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-dark text-light">
            ...
            <div class="modal-body">
                <textarea id="commentInput" class="form-control bg-dark text-light border-secondary" rows="4" placeholder="コメントを入力..."></textarea>
...
async function loadPhotos() {
    const res = await fetch('../api/photos.php?all=1', { credentials: 'include' });
    const data = await res.json();
    ...
    if (photos.length === 0) {
        grid.innerHTML = '<p class="text-center text-muted mt-4 col-12">写真がありません</p>';
        return;
    }
            ...
            <div class="card ${parseInt(p.is_public) === 0 ? 'is-private' : ''}">
                ...
                <div class="card-body">
                    <div class="meta mb-1">
                        ...
                        <i class="bi bi-person"></i> ${p.username || '匿名'}
...
// 公開状態切り替え（0:非公開 → 1:公開 → 2:自分のみ → 0:非公開）
...
function openComment(btn) {
    ...
    document.getElementById('commentPhotoId').value = id;
    document.getElementById('commentInput').value   = current;
